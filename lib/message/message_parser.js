...
MessageParser.parseAsRaw = function(input, callback) {
...
MessageParser.parseAsJSON = function(json, callback) {
    if (!json) {
...
MessageParser.composeAsJSON = function(input, callback) {
    if (!input) {
    ...
    if (!(input instanceof AbstractMessage)) {
        console.log('AbstractMessage?', AbstractMessage);
