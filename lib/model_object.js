...
var ModelObject = Class.extend(StaticClass.withBaseType(function() {
        ...
        Object.defineProperty(this.prototype, propertyName, {
            ...
            set: function(newValue) {
                ...
                if (propertyType === Number) {
                    ...
                    var valid = true;
                    newValue = _.map(newValue, function(entry) {
                        if (entry instanceof LazyModelObject) {
                            return entry;
        ...
        Object.defineProperty(this.prototype, propertyName, {
            ...
            set: function(newValue) {
                if (newValue !== null && newValue !== undefined) {
                    ...
                    } else if (modelObjectType && entry instanceof LazyModelObject) {
                        newValue = newValue;
                    ...
                    if (newValue instanceof LazyModelObject && newValue.modelObject) {
                        newValue.modelObject._setParent(this, propertyName);
                    }
                }
    ...
    modelObjectPropertyWithName: function(propertyName) {
        return this._propertyLookup[propertyName];
    },
