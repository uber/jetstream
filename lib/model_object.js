    ...
    Object.defineProperty(this.prototype, property.name, {
        ...
        set: function(newValue) {
            ...
            if (property.isModelObjectType) {
                _.each(newArray, function(lazyModelObject) {
                    var childModelObject = lazyModelObject.modelObject;
                    if (childModelObject) {
                        childModelObject._setParent(this, property.name);
                    }
                }.bind(this));
            }
...
ModelObject._initValueProperty = function(property) {
    Object.defineProperty(this.prototype, property.name, {
        ...
        set: function(newValue) {
            ...
            if (property.isModelObjectType && newValue.modelObject) {
                newValue.modelObject._setParent(this, property.name);
            }
...
ModelObject.prototype._setParent = function(parent, keyPath) {
    var isModelObjectOrLazyModelObject = parent instanceof ModelObject || 
        parent instanceof LazyModelObject;
    if (!isModelObjectOrLazyModelObject || typeof keyPath !== 'string') {
        this.scope = null;
        this._parentRelationship = null;
        return;
    }
    ...
    if (parent.modelObject && parent.modelObject.scope) {
        this.scope = parent.modelObject.scope;
    }
    ...
    this.getProperties().forEach(function(property) {
        if (property.isModelObjectType) {
            if (property.isCollectionType) {
                this[property.name].forEach(function(lazyModelObject) {
